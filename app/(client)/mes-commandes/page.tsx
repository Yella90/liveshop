        ...
        <div className="flex items-start justify-between gap-4">
          ...
          {storedOrders.length > 0 && (
            <button
              ...
              className="text-xs font-semibold text-red-600 hover:text-red-700 px-3 py-2 rounded-lg hover:bg-red-50 transition-colors"
            >
              Effacer tout
            </button>
          )}
      ...
      <div className="px-5 py-4">
        ...
        {!loading && statusInfo.step > 0 && (
          <div className="mt-2 flex justify-between text-[10px] font-semibold text-slate-500 uppercase tracking-wide">
            ...
            <span className={statusInfo.step >= 2 ? 'text-indigo-600' : ''}>
              Confirmée
            </span>
            <span className={statusInfo.step >= 3 ? 'text-indigo-600' : ''}>
              Livrée
            </span>
          </div>
        )}
